...
class Election
{
  public:
    ...
    /// @brief Constructor: Construct a new Election object with election type
    Election(fstream &ballotFile, string electionType);
     ...
     */
    void writeToAuditFile(string text, string auditFileName);
